...
- [x] [Day 3 - Operators](day03_python_operators.py)
- [x] [Day 4 - Input, Output & Type Casting](day04_input_output_typecasting.py)
- [x] [Day 5 - Conditional Statements](day05_conditional_statements.py)
- [x] [Day 6 - Loops](day06_loops.py)
- [x] [Day 7 - Functions + Revision](day07_functions.py)
- [x] [Day 8 - Python Fundamentals in Practice](day08_python_practice.py)
- [x] [Day 9 - Strings](day09_strings.py)
- [x] [Day 10 - String Indexing & Slicing](day10_string_indexing_slicing.py)
- [x] [Day 11 - Lists](day11_lists.py)
- [x] [Day 12 - List Methods & List Comprehension](day12_list_methods.py)
- [x] [Day 13 - Tuples & Sets](day13_tuples_sets.py)
- [x] [Day 14 - Dictionaries](day14_dictionaries.py)
- [x] [Day 15 - Structured Data](day15_structured_data.py)
- [x] [Day 16 - Functions with Structured Data](day16_functions_with_data.py)
- [x] [Day 17 - Nested Dictionaries](day17_nested_dictionaries.py)
